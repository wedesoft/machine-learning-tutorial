...
The context units are a copy of the hidden unit activations in the previous time step.
...
\ac{RNN} do not perform well at tasks requiring to remember a state over many steps.
\ac{LSTM} and the more simplified \ac{GRU} are designed to perform well at remembering state.
