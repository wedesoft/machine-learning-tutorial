...
When using neural networks, it is generally more effective to use a larger neural network (more hidden units and layers).
They are more prone to overfitting. However this can be addressed using regularization.
