...
Using the activation functions $\sigma_h$ (\emph{e.g.} tanh) and $\sigma_y$ (\emph{e.g.} identity function), the \ac{RNN} is defined as follows\citep{wiki:rnn,elman_finding_1990,suresh}
\begin{align*}
  \begin{split}
...
% https://www.youtube.com/watch?v=yCC09vCHzF8&index=10&list=PLkt2uSq6rBVctENoVBg1TpCC7OQi31AlC 27m
