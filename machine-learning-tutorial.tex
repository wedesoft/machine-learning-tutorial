...
Neural networks can have more layers. \emph{E.g.} a network with four layers
\begin{itemize}
  \item [Layer 1:] Input
...
\end{equation*}
The result is shown in Table \ref{tbl:and}.
\begin{table}[htbp]
  \begin{center}
    \begin{tabular}{cc|c}
      ...
      1 & 1 & 1.000\\
    \end{tabular}
    \caption{Logical ``and'' implemented using a neural network\label{tbl:and}}
  \end{center}
\end{table}
...
\end{equation*}
The result is shown in Table \ref{tbl:or}.
\begin{table}[htbp]
  \begin{center}
    \begin{tabular}{cc|c}
      $x_1$ & $x_2$ & $h_\theta(x)$\\\hline
      ...
      1 & 1 & 1.000\\
    \end{tabular}
    \caption{Logical ``and'' implemented using a neural network\label{tbl:or}}
  \end{center}
\end{table}
Logical ``not'' can be approximated as follows (see Table \ref{tbl:not} for result)
\begin{equation*}
...
\begin{table}[htbp]
  \begin{center}
    \begin{tabular}{cc|c}
      ...
      1 & 0.000\\
    \end{tabular}
    \caption{Logical ``not'' implemented using a neural network\label{tbl:not}}
  \end{center}
\end{table}
...
\begin{table}[htbp]
  \begin{center}
    \begin{tabular}{cccc|c}
      ...
      1 & 1 & 1 & 0 & 1.000\\
    \end{tabular}
    \caption{Logical ``and'' implemented using a neural network\label{tbl:xnor}}
  \end{center}
\end{table}
