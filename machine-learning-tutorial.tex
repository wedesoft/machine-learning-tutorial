...
Using the activation functions $\sigma_h$ and $\sigma_y$, the \ac{RNN} is defined as follows\citep{wiki:rnn,elman_finding_1990}
\begin{align*}
  \begin{split}
...
\ac{RNN} suffer from the \emph{vanishing gradients problem}\ref{elman_finding_1990}.

\subsubsection{Long Short-Term Memory}
\acp{LSTM} use a different architecture preserving the gradients for connections over many time steps.
