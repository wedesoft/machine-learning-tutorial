...
\begin{footnotesize}
  \begin{itemize}
    \item sparse autoencoders\citep{andrewngsparse1,andrewngsparse2}
    \item \ac{RBM}
    \item \acp{CNN}
    \item \ac{LSTM}
    \item \ac{RNN}
...
\subsection{Backpropagation using a Convolutional Neural Network applied to the MNIST Dataset}\label{app:mnistcnn}
\inputminted[frame=lines,linenos,fontsize=\small]{python}{mnist-convolutional.py}

\subsection{Convolution using Tensorflow}
