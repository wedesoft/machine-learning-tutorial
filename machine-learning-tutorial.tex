...
Neural networks can be used for complex tasks such as handwritten digit classification\footnote{see \url{https://www.youtube.com/watch?v=yxuRnBEczUU}}.
...
\emph{E.g.} the desired outputs (and training labels $\syi$) are
\begin{itemize}
  ...
  \item $\ldots$
\end{itemize}
The desired training result is $h_\theta(\sxi)\approx\syi$ with $\syi\in\mathbb{R}^4$.
